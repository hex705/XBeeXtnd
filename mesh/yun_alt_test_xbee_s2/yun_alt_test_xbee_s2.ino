 ...
 * along with XBee-Arduino.  If not, see <http://www.gnu.org/licenses/>.
  ...
  // this one works FINALLY JUNE 28 with the iteads shield
...
uint8_t NAME[] = {'P','i','G','G','I','E','D'};  // set the name of the node
...
void loop() {
  ...
  Console.println("=== SETTING UP NODE IDENTIFIER ===");
